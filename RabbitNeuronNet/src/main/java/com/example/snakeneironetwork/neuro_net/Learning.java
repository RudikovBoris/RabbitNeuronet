...
public class Learning {
    static double learningRate = 0.0000001;

    double[] dE_dBi = new double[neuron.hiddenLayer.length];
    double[] dE_dBH1 = new double[neuron.hiddenLayer2.length];
    double[] dE_dBH2 = new double[neuron.hiddenLayer3.length];
    double[] dE_dBH3 = new double[neuron.outputLayer.length];
    ...
    double[] dE_dW3 = new  double[neuron.weightHidden3.length];


    double[] dE_dH1 = new  double[neuron.hiddenLayer.length];
    double[] dE_dH2 = new  double[neuron.hiddenLayer2.length];
    double[] dE_dH3 = new  double[neuron.hiddenLayer3.length];
    ...
    public void cross_entropy(double[] myOutNeuron, double[] learningDate){
        ...
        public void learningProcess(){
            ...
            foundError_dE_dB(dE_dBH3, dE_dO);
            foundError_dE_dW_errorWeight(dE_dW3, dE_dO, neuron.hiddenLayer3);


            errorAll_dE_Neuron(dE_dH3,neuron.weightHidden3,dE_dO);
            foundError_dE_neuron(neuron.hiddenLayer3, dE_dH3);
            foundError_dE_dB(dE_dBH2, dE_dH3);
            foundError_dE_dW_errorWeight(dE_dW2, dE_dH3,neuron.hiddenLayer2);


            errorAll_dE_Neuron(dE_dH2,neuron.weightHidden2,dE_dH3);
            foundError_dE_neuron(neuron.hiddenLayer2, dE_dH2);
            foundError_dE_dB(dE_dBH1, dE_dH2);
    ...
    public void newWeight(){
        ...
        newWeightShort(neuron.weightHidden3, dE_dW3,learningRate);
    ...
    public void newBias(){
        ...
        newBiasFormula(neuron.biasHidden3, dE_dBH3, learningRate);
    }
